...
export default function ContactoPage() {
  ...
  return (
    <div className="bg-brand-white pb-28">
      ...
      />
      <section className="bg-brand-dark pb-16 pt-32 text-brand-white">
        <Container>
          <div className="max-w-5xl space-y-7">
            ...
            <h1 className="text-4xl font-medium leading-none md:text-6xl">Hablemos de dónde tu operación pierde tiempo, margen y control.</h1>
            ...
            <div className="space-y-10 lg:col-span-5">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="rounded-lg border border-brand-dark/10 p-6">
                  ...
                  <h3 className="mt-4 text-lg font-bold text-brand-dark">Brief útil para venta</h3>
                  <p className="mt-3 text-sm leading-relaxed text-brand-dark/60">
            ...
            >
              ...
              <form className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2" onSubmit={handleSubmit}>
                <label className="space-y-2">
                  ...
                  <input name="nombre" required className="w-full rounded-lg border border-brand-white/15 bg-brand-white/8 px-4 py-3 outline-none transition focus:border-brand-primary" placeholder="Tu nombre" />
                </label>
                <label className="space-y-2">
                  <span className="text-xs font-bold uppercase text-brand-white/45">Empresa</span>
                  <input name="empresa" required className="w-full rounded-lg border border-brand-white/15 bg-brand-white/8 px-4 py-3 outline-none transition focus:border-brand-primary" placeholder="Nombre de empresa" />
                </label>
                <label className="space-y-2">
                  <span className="text-xs font-bold uppercase text-brand-white/45">Email corporativo</span>
                  <input name="email" type="email" required className="w-full rounded-lg border border-brand-white/15 bg-brand-white/8 px-4 py-3 outline-none transition focus:border-brand-primary" placeholder="nombre@empresa.com" />
                </label>
                <label className="space-y-2">
                  <span className="text-xs font-bold uppercase text-brand-white/45">Teléfono / WhatsApp</span>
                  <input name="telefono" className="w-full rounded-lg border border-brand-white/15 bg-brand-white/8 px-4 py-3 outline-none transition focus:border-brand-primary" placeholder="+54..." />
                </label>
                <label className="space-y-2">
                  <span className="text-xs font-bold uppercase text-brand-white/45">Rubro</span>
                  <select name="rubro" className="w-full rounded-lg border border-brand-white/15 bg-brand-dark px-4 py-3 outline-none transition focus:border-brand-primary">
                ...
                <label className="space-y-2">
                  ...
                  <select name="tamano" className="w-full rounded-lg border border-brand-white/15 bg-brand-dark px-4 py-3 outline-none transition focus:border-brand-primary">
                ...
                <label className="space-y-2 md:col-span-2">
                  ...
                  <select name="prioridad" className="w-full rounded-lg border border-brand-white/15 bg-brand-dark px-4 py-3 outline-none transition focus:border-brand-primary">
                ...
                <label className="space-y-2 md:col-span-2">
                  ...
                  <textarea name="dolor" rows={4} className="w-full resize-none rounded-lg border border-brand-white/15 bg-brand-white/8 px-4 py-3 outline-none transition focus:border-brand-primary" placeholder="Ej: presupuestos lentos, compras sin trazabilidad, stock desordenado, eventos web sin seguimiento, datos duplicados..." />
                </label>
                <div className="md:col-span-2">
