  ...
  es: {
    ...
    services: {
      ...
      examples: [
        ...
        ['Urban Projects Pub para constructoras', 'Backoffice de obras con proyectos, partidas, recursos, costos vs precios, markup, margen, desvíos, KPIs, unidades vendibles y documentación comercial.'],
  ...
  en: {
    ...
    footer: {
      ...
      links: [
        ...
        'Product inventory',
        'InmoPub real estate',
        'Urban Projects Pub construction',
        'Marketing and leads',
        'Connected websites',
    ...
    services: {
      ...
      examples: [
        ...
        ['Urban Projects Pub for builders', 'Construction backoffice for projects, cost codes, resources, cost vs price, markup, margin, deviations, KPIs, sellable units and commercial documents.'],
  ...
  pt: {
    ...
    services: {
      ...
      examples: [
        ...
        ['Urban Projects Pub para construtoras', 'Backoffice de obras com projetos, partidas, recursos, custos vs preços, markup, margem, desvios, KPIs, unidades vendáveis e documentos comerciais.'],
